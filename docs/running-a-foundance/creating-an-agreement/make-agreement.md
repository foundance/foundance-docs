...
The only difference is, you can also specify a _cliff_ when setting up vesting. A cliff means the co-founder will start getting tokens only after the cliff period has passed.
