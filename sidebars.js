...
const sidebars = {
  ...
  tutorialSidebar: [
    ...
    {
      type: "category",
      label: "Foundance Smart Contracts",
      link: {
        type: "generated-index",
        title: "Foundance Smart Contracts",
        description:
          "Technical documentation about the Smart Contracts used to create and manage your projects on chain.",
